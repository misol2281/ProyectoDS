...
public class ControladorMaterial extends HttpServlet {
    ...
    String listar = "vistas/vistasMaterial/listar.jsp";
    String add = "vistas/vistasMaterial/add.jsp";
    String edit = "vistas/vistasMaterial/edit.jsp";
    int id;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorMaterial</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorMaterial at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
